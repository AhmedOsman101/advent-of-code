...
- **Branches**:
  ...
  - `php` — Solutions in PHP
  - ...and more as I explore other languages.

## Goals

- Practice problem solving across multiple languages.
- Write clean, efficient, and idiomatic code in each language.
- Document my approach to each challenge.

## About Advent of Code

[Advent of Code](https://adventofcode.com) is an annual set of Christmas-themed programming puzzles released daily from December 1st to 25th.
It's a great way to improve your coding skills and explore new languages.
